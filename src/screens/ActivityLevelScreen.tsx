...
export default function ActivityLevelScreen({ navigation }: Props) {
  ...
  const [activityLevel, setActivityLevel] = useState('Training 5-7 times (2 week, one day one )');
                ...
                <View
                  style={[
                    styles.tickLine,
                    {
                      height: h % 10 === 0 ? 28 : 16,
                      backgroundColor:
                        h === selectedHeight ? Colors.primary : Colors.gray400,
                      width: h === selectedHeight ? 2.5 : 1.5,
                    },
                  ]}
                />
                {h % 10 === 0 && (
                  <Text style={styles.tickLabel}>{h}</Text>
                )}
              </TouchableOpacity>
            ))}
          </ScrollView>
              ...
              >
                <Text
                  style={[
                    ...
                    { fontSize: w === selectedWeight ? 22 : w === selectedWeight - 1 || w === selectedWeight + 1 ? 18 : 14 },
                  ]}
                >
                  {w}
                </Text>
...
const styles = StyleSheet.create({
  ...
  progressBar: {
    height: 6, backgroundColor: Colors.gray200,
